...
//   // Function to create a policy dot
...
//     // Add tooltip
//     dot.title = policy.name;

//     // Create the label
//     const label = document.createElement("div");
//     label.className = "policy-label";
//     label.textContent = policy.name;
...
//           <div class="platform-detail-header">
//             <h3>${policy.name}</h3>
//             <div class="platform-detail-icon" style="background-color: ${quadrantColor}; width: 30px; height: 30px; border-radius: 50%;"></div>
//           </div>
//           <div class="platform-detail-content">
//             <div class="position-info">
//               <div class="position-label">Position:</div>
